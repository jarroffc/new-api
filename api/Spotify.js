...
async function spotifyDownload(url) {
  ...
  const metaResponse = await axios.post('https://spotmate.online/en', { url }, {
        headers: {
  ...
  const dlResponse = await axios.post('https://spotmate.online/getTrackData', { spotify_url: spotifyUrl }, {
